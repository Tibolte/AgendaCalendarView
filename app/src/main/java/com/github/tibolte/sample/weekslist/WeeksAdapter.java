...
import com.github.tibolte.agendacalendarview.calendar.BaseViewHolder;
...
public class WeeksAdapter extends ViewAdapter<IWeekItem, WeeksAdapter.WeekViewHolder> {
    ...
    public WeekViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_week,
                parent, false);
    ...
    public class WeekViewHolder extends BaseViewHolder<IWeekItem> {
